"""
Script para fazer scraping em tempo real do preço de LIVRETO
"""
import sys
import json
import time
...
def scrape_preco_tempo_real(opcoes, quantidade):
    """
    Faz scraping do preço de LIVRETO no site da Eskenazi em tempo real.
    """
    ...
    try:
        ...
        # Livreto NÃO tem select de quantidade
        # Mapeamento: Options[0] = select[0] (Formato)
        mapeamento_livreto = {
        ...
        for campo, valor in opcoes.items():
            ...
            idx = mapeamento_livreto.get(campo)
