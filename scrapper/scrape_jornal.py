"""
Script para fazer scraping em tempo real do preço de JORNAL DE BAIRRO
"""
import sys
import json
import time
...
def scrape_preco_tempo_real(opcoes, quantidade):
    """
    Faz scraping do preço de JORNAL DE BAIRRO no site da Eskenazi em tempo real.
    """
    ...
    try:
        ...
        # Jornal NÃO tem select de quantidade (igual ao tabloide)
        mapeamento_jornal = {
        ...
        for campo, valor in opcoes.items():
            ...
            idx = mapeamento_jornal.get(campo)
