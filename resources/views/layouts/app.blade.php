...
<head>
    ...
    <title>@yield('title', 'GrÃ¡fica Todah ServiÃ§os GrÃ¡ficos')</title>
        ...
        @if($requestOnlyMode)
            <div class="bg-warning-subtle border-bottom py-2">
                <div class="container text-center small text-muted">
                    Estamos operando no modo orÃ§amento. Solicite um orÃ§amento pelo WhatsApp ou formulÃ¡rio de contato.
                </div>
            </div>
        @endif
                    ...
                    @elseif(!empty($globalWhatsappLink))
                        <li class="nav-item">
                            <a class="btn btn-outline-primary ms-lg-3" href="{{ $globalWhatsappLink }}" target="_blank">
                                <i class="fab fa-whatsapp me-1"></i> Solicitar orÃ§amento
                            </a>
                        </li>
                    @endif
                </ul>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="#">CartÃµes de Visita</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link text-danger" href="#">PromoÃ§Ãµes</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <footer class="bg-dark text-white py-5 mt-5">
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-md-6">
                    <h5 class="text-uppercase fw-bold mb-3">GrÃ¡fica Todah ServiÃ§os GrÃ¡ficos</h5>
                    <p class="mb-3 small">{{ $globalFooterText ?: 'Atualize este texto nas configuraÃ§Ãµes para reforÃ§ar a mensagem da sua marca.' }}</p>
                    @if(!empty($globalWhatsappLink))
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    @endif
                    <p class="mb-0 small mt-3">&copy; 2025 GrÃ¡fica Todah ServiÃ§os GrÃ¡ficos. Todos os direitos reservados.</p>
                </div>
            </div>
        </div>
    </footer>
